...
<head>
    ...
    <title>Đăng Ký - DigitalPro</title>
...
<body>
    <div class="register-box">
        <h2 class="text-white text-center mb-4">Đăng Ký DigitalPro</h2>
        ...
        <form action="http://localhost:8000/auth/doRegister" method="POST">
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary w-100 py-2 mt-3">Đăng Ký Ngay</button>
        </form>
        
        <p class="text-center text-white-50 mt-4 mb-0">
            Đã có tài khoản? <a href="http://localhost:8000/auth/login" class="text-primary">Đăng nhập</a>
        </p>
    </div>
</body>
</html>
